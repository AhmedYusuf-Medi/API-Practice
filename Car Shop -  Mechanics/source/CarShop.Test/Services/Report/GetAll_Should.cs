namespace CarShop.Test.Services.Report
{
    ...
    public class GetAll_Should : BaseTest
    {
        ...
        [DataRow(2, 1)]
        [DataRow(1, 1)]
        public async Task GetAllShould_ReturnReportResponseModels(int perPage, int page)
        {
            ...
            using (var assertContext = new CarShopDbContext(this.Options))
            {
                ...
                Assert.AreEqual(actual.Message, string.Format(ResponseMessages.Entity_GetAll_Succeed, Constants.Reports));
