namespace CarShop.Test.Services.VehicleTypes
{
    ...
    public class GetAll_Should : BaseTest
    {
        ...
        [DataRow(3, 1)]
        [DataRow(2, 1)]
        public async Task GetAllShould_ReturnVehicleTypeResponseModels(int perPage, int page)
        {
            ...
            using (var assertContext = new CarShopDbContext(this.Options))
            {
                ...
                Assert.AreEqual(actual.Message, string.Format(ResponseMessages.Entity_GetAll_Succeed, Constants.VehicleTypes));
